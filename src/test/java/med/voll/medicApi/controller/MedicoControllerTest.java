...
class MedicoControllerTest {
    ...
    @Autowired
    private JacksonTester<MedicoDtoCreate> dadosCadastroMedicoJson;

    @Autowired
    private JacksonTester<MedicoDtoGetAll> dadosDetalhamentoMedicoJson;
    ...
    void cadastrar_cenario2() throws Exception {
        var dadosCadastro = new MedicoDtoCreate(
                "Medico",
                "medico@voll.med",
                "61999999999",
                "123456",
        ...
        var dadosDetalhamento = new MedicoDtoGetAll(
                null,
                dadosCadastro.nome(),
                dadosCadastro.email(),
                dadosCadastro.crm(),
